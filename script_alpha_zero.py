...
flags.DEFINE_integer(
    "replay_buffer_size", 2**10, "How many states to store in the replay buffer."
)
flags.DEFINE_integer(
    "replay_buffer_reuse", 3, "How many times to learn from each state."
)
flags.DEFINE_float("learning_rate", 0.01, "Learning rate.")
flags.DEFINE_float("weight_decay", 0.1, "Learning rate decay.")
flags.DEFINE_float("l2_regularisation", 0.01, "L2 regularization strength.")
flags.DEFINE_float("momentum", 0.01, "Momentum.")
flags.DEFINE_float("policy_epsilon", 0.3, "What noise epsilon to use.")
...
flags.DEFINE_integer(
    "temperature_drop",
    10,  # Less than AZ due to short games.
...
flags.DEFINE_integer(
    "evaluation_window", 100, "How many games to average results over."
)
flags.DEFINE_integer(
    "eval_levels",
    7,
...
def main(unused_argv):
    config = alpha_zero.Config(
        ...
        l2_regularisation=FLAGS.l2_regularisation,
